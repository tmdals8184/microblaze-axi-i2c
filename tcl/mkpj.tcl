...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [concat $sv_files $v_files]
  foreach ifile $files {
...
set src_dir [file normalize "$tcl_dir/../src"]
...
set _xil_proj_name_ "Microblaze_AXI-I2C"
...
set script_file "microblaze-axi-i2c.tcl"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "i2c_master" -objects $obj
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/../src/tb_i2c_master.sv" ]\
]
...
set_property -name "top" -value "tb_i2c_master" -objects $obj
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "D:/work/harman/251111_I2C_Master/251111_I2C_Master.srcs/utils_1/imports/synth_1" -objects $obj
